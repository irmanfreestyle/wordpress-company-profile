    ...
    at_document.ready( function() {
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                construction_field_sidebar_layout = $('#construction_field_sidebar_layout'),
                construction_field_meta_fields = $('#construction_field_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                construction_field_sidebar_layout.addClass('hidden');
                construction_field_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                construction_field_sidebar_layout.removeClass('hidden');
                construction_field_meta_fields.removeClass('hidden');
